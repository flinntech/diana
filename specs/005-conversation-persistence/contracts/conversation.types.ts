/**
 * Conversation Persistence - Type Contracts
 *
 * Feature: 005-conversation-persistence
 * Date: 2025-12-13
 *
 * These interfaces define the contracts for conversation persistence.
 * Implementation must adhere to these types.
 */

import type { Message, ToolCall, MessageRole } from '../../../src/types/agent.js';
...
/**
 * Extended chat command options
 */
export interface ExtendedChatCommandOptions {
  /** Enable debug output */
  debug?: boolean;
  ...
  /** Resume a previous conversation (optional ID) */
  resume?: string | true; // true = show picker, string = specific ID
}

/**
 * Conversation list display item
 */
